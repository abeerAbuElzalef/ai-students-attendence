...
const { Attendance, Student } = require('./_lib/models');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (req.method === 'POST') {
      const { studentId, date: bodyDate, present } = req.body;
      ...
      const attendance = await Attendance.findOneAndUpdate(
        ...
        { student: studentId, class: student.class, date: attendanceDate, present: present },
